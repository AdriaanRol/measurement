...
class RS_SMB100_noIQ(Instrument):
    '''
    ...
    def __init__(self, name, address, reset=False, max_pwr=-5, max_cw_pwr=-5):
        '''
    ...
    def _do_set_power(self,power):
        ...
        elif power > self.get_max_pwr():
            logging.warning(__name__ + ' : power exceeds max power; power not set.')
            raise ValueError('power exceeds max power')
    ...
    def _do_get_max_pwr(self):
        return self._max_pwr
