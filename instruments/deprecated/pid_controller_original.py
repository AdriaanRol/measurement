...
class pid_controller(Instrument):
    ...
    def __init__(self, name, set_ctrl_func=None, get_val_func=None, **kw):
        ...
        initial_control_parameter=kw.get('initial_control_parameter',0)
        self.set_control_parameter(initial_control_parameter)
        ...
        self._proportional_pid=kw.get('proportional_pid',False)
        ...
        if (self.get_control_parameter() != 0): self._parlist.remove('control_parameter')
    ...
    def _new_control_parameter(self):
        ...
        # print err_vals, times
        if self._proportional_pid:
            return self.get_control_parameter() + pterm + iterm + dterm
    ...
    def _update(self):
        ...
        if not self.set_control_parameter(self._new_control_parameter()):
