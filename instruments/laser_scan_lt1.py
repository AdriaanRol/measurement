...
class laser_scan_lt1(Instrument):
    ...
    def __init__(self, name, address=None):
        ...
        self._adwin = qt.instruments['adwin_lt1']
        self._counters = qt.instruments['counters_lt1']
        self._physical_adwin = qt.instruments['physical_adwin_lt1']
        self._ins_Laser = qt.instruments['NewfocusLaser']  ##FIXME NewfocusLaser_lt1 does not exist yet
