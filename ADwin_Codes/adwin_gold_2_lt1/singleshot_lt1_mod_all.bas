...
DIM DATA_25[max_SSRO_dim] AS LONG AT EM_LOCAL ' SSRO counts
DIM DATA_26[max_stat] AS LONG ' statistics
DIM DATA_27[8] AS FLOAT AT EM_LOCAL 'repump vs mod
DIM DATA_28[8] AS FLOAT AT EM_LOCAL 'CR vs mod
...
DIM noof_repump_mod, noof_cr_mod AS LONG
DIM current_repump_mod, current_cr_mod AS LONG
...
INIT:
  ...
  noof_repump_mod              = 3'DATA_20[23]
  noof_cr_mod                  = 1'DATA_20[23]
      ...
      CASE 0    ' green repump
        ...
        ELSE 
          ...
          ELSE 
            ...
            DATA_28[current_repump_mod]=DATA_28[current_repump_mod]*0.9999+repump_mod_control*(counts-old_counts)
            old_counts=counts
          ENDIF
        ENDIF
      ...
      CASE 1    ' Ex/A laser CR check
        ...
        ELSE 
          ...
          ELSE
            ...
            DATA_27[current_cr_mod]=DATA_27[current_cr_mod]*0.99999+cr_mod_control*(counts-old_counts)
            old_counts=counts
          ENDIF
        ENDIF
