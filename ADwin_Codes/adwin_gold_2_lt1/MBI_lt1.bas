  ...
  ELSE
    ...
    SELECTCASE mode
      ...
      CASE 4    ' A laser spin pumping
        ...
        IF (timer = 0) THEN
          DAC(A_laser_DAC_channel, 3277*A_SP_voltage_after_MBI+32768) ' turn on A laser, for spin pumping after MBI
          DAC(E_laser_DAC_channel, 3277*E_SP_voltage_after_MBI+32768) ' turn on E laser, for spin pumping after MBI
        ELSE 
