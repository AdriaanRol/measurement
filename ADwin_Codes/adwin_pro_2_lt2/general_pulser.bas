...
EVENT:
  ...
  ELSE
    IF (timer=0) THEN
      P2_DAC(DAC_MODULE,dac1_channel, 3277*DATA_21[mode]+32768) 
      P2_DAC(DAC_MODULE,dac2_channel, 3277*DATA_22[mode]+32768) 
      P2_DAC(DAC_MODULE,dac3_channel, 3277*DATA_23[mode]+32768)
