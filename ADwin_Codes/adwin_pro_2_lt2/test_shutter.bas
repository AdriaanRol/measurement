...
INIT:
  ...
  wait_steps        = 100      'number of iterations to wait between pulses, 1 iteration corresponds to 10 ms 
  shutter_open_time = 5000000  'time that the shutter is open in 10 ns (first number is ms)
