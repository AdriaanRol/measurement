...
' Bookmarks                      = 30,72,113,114,116,178,182,236,246
'<Header End>
...
INIT:
  ...
  par_67 = 0                      ' tuning boolean, if set to 1, the lt1_cr check is always triggered
...
EVENT:
  ...
  'do_cr_lt1_check = do_cr_lt1_check + Par_67
