...
DIM DATA_27[max_sweep_len] AS LONG AT DRAM_EXTERN    ' SSRO last counts
DIM DATA_28[max_sweep_len] AS LONG AT DRAM_EXTERN      ' SSRO counts
DIM DATA_29[max_sweep_len] AS LONG AT DRAM_EXTERN      ' cond SSRO counts
