{
   ...
   installed in the system dll path, typically 'c:\windows\system32\')
   ...
   Note: PicoHarp manufacturer driver has a bug, data acquisition in TTTR mode
         just starts after two pulses are sent to channel0 (start).
}
