...
#        self.ui.ModPeriod.setValue(self._ins.get_ModPeriod())
...
#        self.ui.ModPeriod.valueChanged.connect(self.ModPeriodChanged)
...
#    @QtCore.pyqtSlot(int)
#    def ModPeriodChanged(self, val):
#        self._ins.set_ModPeriod(val)
...
#        if changes.has_key('ModPeriod'):
#            self.ui.ModPeriod.setValue(changes['ModPeriod'])
