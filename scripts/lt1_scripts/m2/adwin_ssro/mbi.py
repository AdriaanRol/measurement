...
from sequence_ssro import SequenceSSROMeasurement


### Stuff that's used everywhere
...
### Classes
class MBIMeasurement(SequenceSSROMeasurement):
    mprefix = 'MBIMeasurement'
    
    def __init__(self, name, adwin, awg):
        SequenceSSROMeasurement.__init__(self, name, adwin, awg)
...
class ElectronRabi(MBIMeasurement):
