...
cfg.set('protocols/Teleportation/AWG_done_DI_channel',  16)
cfg.set('protocols/Teleportation/AWG_event_jump_DO_channel',  7)
cfg.set('protocols/Teleportation/AWG_start_DO_channel',  1)
cfg.set('protocols/Teleportation/A_laser_DAC_channel',  6)
cfg.set('protocols/Teleportation/Ex_laser_DAC_channel',  7)
cfg.set('protocols/Teleportation/counter_channel',  1)
cfg.set('protocols/Teleportation/yellow_laser_DAC_channel',  3)
cfg.set('protocols/Teleportation/green_laser_DAC_channel',  4)
cfg.set('protocols/Teleportation/green_off_amplitude',  0.0)
cfg.set('protocols/Teleportation/green_repump_amplitude',  100e-6)
cfg.set('protocols/Teleportation/green_repump_duration',  10)
cfg.set('protocols/Teleportation/yellow_off_voltage',  0)
cfg.set('protocols/Teleportation/green_off_voltage',  0)
...
cfg.set('protocols/sil2-default/pulses/4MHz_pi_amp',  0.704)
...
cfg.set('protocols/sil2-default/pulses/4MHz_pi2_amp',  0.704)
cfg.set('protocols/sil2-default/pulses/4MHz_pi2_mod_frq',  finit)

cfg.set('protocols/sil2-default/pulses/selective_pi_duration',  2700e-9)
...
cfg.set('protocols/sil2-default/pulses/CORPSE_pi_amp',  0.70)
...
cfg.set('protocols/sil2-default/pulses/pi2pi_mIm1_amp', 0.169)
...
cfg.set('protocols/sil2-default/pulses/pi2pi_mI0_amp', 0.177)
...
### Nitrogen pulses
cfg.set('protocols/sil2-default/pulses/N_pi_duration', 91.1e-6)
cfg.set('protocols/sil2-default/pulses/N_pi_amp', 1)

cfg.set('protocols/sil2-default/pulses/N_pi2_duration', 91.1e-6/2.)
...
cfg.set('protocols/sil2-default/AdwinSSRO/Ex_RO_amplitude',  5e-9)
...
### sil2, Teleportation ###
cfg.set('protocols/sil2-default/Teleportation/A_CR_amplitude',  10e-9)
cfg.set('protocols/sil2-default/Teleportation/A_RO_amplitude',  0.)
cfg.set('protocols/sil2-default/Teleportation/A_SP_amplitude',  15e-9)
cfg.set('protocols/sil2-default/Teleportation/Ex_CR_amplitude',  10e-9)
cfg.set('protocols/sil2-default/Teleportation/Ex_RO_amplitude',  5e-9)
cfg.set('protocols/sil2-default/Teleportation/Ex_SP_amplitude',  0.)
cfg.set('protocols/sil2-default/Teleportation/yellow_repump_amplitude',  0)
cfg.set('protocols/sil2-default/Teleportation/yellow_repump_duration',  3) 
cfg.set('protocols/sil2-default/Teleportation/CR_duration',  100)
cfg.set('protocols/sil2-default/Teleportation/CR_threshold_preselect',  40)
cfg.set('protocols/sil2-default/Teleportation/CR_threshold_probe',  40)
cfg.set('protocols/sil2-default/Teleportation/time_before_forced_CR',  500000)
cfg.set('protocols/sil2-default/Teleportation/teleportation_repetitions',  1000)
