...
cfg.set(branch+        'MBI_threshold',                 1)
cfg.set(branch+        'SP_E_duration',                 100)
cfg.set(branch+        'repump_after_MBI_duration',     5)
cfg.set(branch+        'repump_after_MBI_amplitude',    10e-9)
cfg.set(branch+        'repump_after_E_RO_duration',    5)
cfg.set(branch+        'repump_after_E_RO_amplitude',   10e-9)
