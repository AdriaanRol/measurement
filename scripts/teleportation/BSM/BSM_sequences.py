...
class BSMMsmt(pulsar_msmt.MBI):
    ...
    def load_settings(self):
        ...
        self.params_lt1['MW_during_LDE'] = 1 if LDE_DO_MW else 0
    ...
    def update_definitions(self):
        ...
        self.pulsar_lt1.set_channel_opt('Velocity1AOM', 'high', self.params_lt1['SP_voltage_AWG'])
    ...
    def BSM_elements(self, name, time_offset, **kw):
        return tseq._lt1_BSM_elements(self, name, time_offset, **kw)
        ...
        for i,t in enumerate(self.params_lt1['evolution_times']):
            ...
            if eigenstate == '-1':
                ...
                analysis_elt.append(pulse.cp(self.CORPSE_pi,
                    phaselock = False)) # phaselock false for CORPSE: only care about inversion here
                analysis_elt.append(pulse.cp(self.TIQ, 
                    length=200e-9))
            else:
