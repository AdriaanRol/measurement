...
# intial setup
m = LDEMeasurement('SPIN-PHOTON-LT2-with-basis-rot', 'LDE')

### measurement parameters

# gate parameters
m.set_gate_good_phase       = -1 #either 1 or -1
m.set_phase_locking_on      = 1#1 #either 0 (off) or 1 (on)
...
m.wait_after_pi2            = 144  #NOTE: change this for regular pulses!
...
m.eom_start                 = 40
m.eom_off_duration          = 200 #NOTE: change this to duration of CORPSE or regular!
...
m.wait_after_opt_pi         = 170 # determines start of MW pi pulse NOTE: change this for regular pulses!
m.wait_after_opt_pi2_lt1    = 336 # determines start of basis rotation NOTE: change this for regular pulses!
m.wait_after_opt_pi2_lt2    = 338 # determines start of basis rotation NOTE: change this for regular pulses!
...
m.pi2_lt1_amplitude          = 0.51194#0.4934#0.4991#0.4818  #NOTE
m.pi2_lt2_amplitude          = 0.6198  #NOTE #  only for regular pulse sequence

    # Pi pulse
m.pi_lt1_duration           = 50 #58
m.pi_lt2_duration           = 50
m.pi_lt1_amplitude          = 0.4491#0.44785#0.4491#0.45295 #NOTE
m.pi_lt2_amplitude          = 0.5756  #NOTE #  only for regular pulse sequence
...
m.CORPSE_pi_amp_lt2             = 0.4824#NOTE
...
adpar['SSRO_duration']              = 29  #FIXME get this from calibration meas
