...
m.wait_after_opt_pi         = 70 # determines start of MW pi pulse NOTE: change this for regular pulses!
m.wait_after_opt_pi2_lt1    = 232 # determines start of basis rotation NOTE: change this for regular pulses!
m.wait_after_opt_pi2_lt2    = 232 # determines start of basis rotation NOTE: change this for regular pulses!
...
m.pi2_lt2_amplitude          = 0.58   #  only for regular pulse sequence

    # Pi pulse
m.pi_lt1_duration           = 50 #58
m.pi_lt2_duration           = 50
m.pi_lt1_amplitude          = 0.4491#0.44785#0.4491#0.45295 #NOTE
m.pi_lt2_amplitude          = 0.58   #  only for regular pulse sequence
