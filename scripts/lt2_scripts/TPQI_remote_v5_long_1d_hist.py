...
par_opt_min_cnts_lt1 = 200000
par_opt_min_cnts_lt2 = 70000
...
def generate_sequence(do_program=True):
    ...
    seq.add_pulse('start___long_hist', chan_hhsync, 'optical_rabi', start = 0,
            duration = 50)
...
def measurement_cycle(hh_measurement_time):
    ...
    if hh_measurement_time > 0:
        ...
        #        )
        [histogram,hist_ch0,hist_ch1,hist_ch1_long] = hharp.get_T3_pulsed_g2_2DHistogram_v4(
                binsize_sync=par_binsize_sync,
                range_sync=par_range_sync,
                binsize_g2=par_binsize_g2,
                range_g2=par_range_g2,
...
#    initialize_hh()
    ...
    repetitions = 20
    hh_measurement_time = int(0)#1e3 * 60 * 15) #ms
