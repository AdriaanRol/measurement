...
# intial setup
m = LDEMeasurement('Spin_photon_LT1_new_APDs', 'LDESpinPhotonCorr')
...
# general LDE
m.measurement_time          = 2*60 #in seconds
...
m.MW_power_lt1              = 20 
m.MW_power_lt2              = -30 
m.MW_freq_lt1               = 2.82882E9 #NOTE Needs to be adjusted
m.MW_freq_lt2               = 2.8586E9 #NOTE Adjust this by calibrating the pulses.
m.pi2_lt1_duration          = 48 #NOTE Check
m.pi2_lt2_duration          = m.pi2_lt1_duration

m.wait_after_pi2            = 0
m.pi_lt1_duration           = 96 #NOTE Check
m.pi_lt2_duration           = m.pi_lt1_duration

m.MW_pulsemod_risetime_lt2  = 10
m.MW_pulsemod_risetime_lt1  = 10

if not debug_mode:
    m.pi2_lt2_amplitude         = 0.78 #NOTE Check
    m.pi2_lt1_amplitude         = 1 #NOTE Check
    m.pi_lt2_amplitude          = 0.78 #NOTE Check
    m.pi_lt1_amplitude          = 1 #NOTE Check
...
# HH settings
m.presync_pulses            = 10
m.postsync_pulses           = 10 #NOTE Set to 10
m.binsize_T3                = 8
