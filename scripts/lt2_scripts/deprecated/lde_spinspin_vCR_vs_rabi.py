...
name = 'Rabi_vs_CR_1_20nW' #NOTE: fill in measurement name
...
# general LDE
m.measurement_time          = 100 #in seconds
...
m.A_SP_power                = 15e-9  
m.A_SP_amplitude            = A_aom_lt1.power_to_voltage(m.A_SP_power)
...
if long_pulse_settings:
    m.eom_pulse_duration    = 50 #NOTE 10
    m.eom_pulse_offset      = -10 #NOTE -8 
else:
    m.eom_pulse_duration    = 2
    m.eom_pulse_offset      = 0    

m.eom_aom_amplitude         = 1.
