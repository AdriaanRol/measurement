...
class LDEMeasurement(meas.Measurement):
    ...
    def generate_sequence(self, do_program=True):
        ...
        seq.add_pulse('pi_pulse_lt1', channel = chan_mw_pm, element = 'lde',
                duration = 700,
                start =  (0 - \
                            self.MW_pulsemod_risetime_lt1),
        ...
        seq.add_pulse('start'+str(i),  chan_hhsync, 'lde',         
                ...
                amplitude = 0, start_reference = 'start'+str(i-1),  
                link_start_to = 'start') 
        last = 'start'+str(i)
...
adpar['SSRO_duration_lt1']          = 13    #FIXME get this from calibration meas.
