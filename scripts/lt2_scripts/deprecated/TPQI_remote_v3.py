...
par_opt_min_cnts_lt1 = 155000
par_opt_min_cnts_lt2 = 130000
par_zpl_cts_break = 100000

# configure pulses and sequence
par_sp_duration = 5000
par_sp_voltage_lt1 = .12
par_sp_voltage_lt2 = .2
par_rabi_reps = 100
par_eom_start = 20
...
def optimize():
    ...
    print 'Countrate in ZPL with red on: ', adwin_lt1.get_countrates()[0]
    if (adwin_lt1.get_countrates()[0] > par_zpl_cts_break) or (adwin_lt2.get_countrates()[1] > par_zpl_cts_break):
        awg.set_ch4_marker1_low(0)
