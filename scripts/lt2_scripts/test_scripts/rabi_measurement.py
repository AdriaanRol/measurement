...
class RabiMeasurement(Measurement):
    ...
    def setup(self, PLstart, PLstop, PLsteps, reps, *arg, **kw):
        ...
        self.set_sweep(name='MW frequency', count=PLsteps,
        ...
        self.add_MW('MW', self.ins_mw, frequency=self.f_central,
...
if __name__ == "__main__":
    ...
    m.setup(0, 100e-9, 21, int(3e6), do_program=True)
    m.generate_sequence('test')
    #m.measure()
    print 'your mother is rabi'
