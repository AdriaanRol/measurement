...
name = 'testing-after-pulsing-raw-data' #NOTE: fill in measurement name
...
class LDEMeasurement(meas.Measurement):
    ...
    def generate_sequence_regular_pulses(self, do_program=True): 
        ...
        #COMMENT in IF YOU WANT A DEBUG SYNC #NOTE
...
# general LDE
m.measurement_time          = 45*60 #in seconds
...
# spin manipulation
m.MW_power_lt1              = 20 #NOTE should be 20 dbm 
m.MW_power_lt2              = 20
m.MW_freq_lt1               = 2.8237e9 #NOTE Needs to be adjusted
m.MW_freq_lt2               = 2.8287e9 #NOTE Adjust this by calibrating the pulses.
...
# MW Pulses (regular)
    # Pi2 pulse
m.pi2_lt1_duration           = 30 #29
m.pi2_lt2_duration           = 25
m.pi2_lt1_amplitude          = 0.4762 #0.6575  #NOTE
m.pi2_lt2_amplitude          = 0.6103  #NOTE #  only for regular pulse sequence

    # Pi pulse
m.pi_lt1_duration           = 60 #58
m.pi_lt2_duration           = 50
m.pi_lt1_amplitude          = 0.4238 #NOTE
m.pi_lt2_amplitude          = 0.5613 #NOTE #  only for regular pulse sequence
...
adpar['CR_preselect']               = 20 # is overwritten by the TPQI monitor
adpar['CR_probe']                   = 15 # is overwritten by the TPQI monitor
adpar['green_repump_duration']      = 10
adpar['wait_before_SSRO']           = 3
adpar['SSRO_duration']              = 19  #NOTE
...
adpar_lt1['CR_preselect']               = 55
adpar_lt1['CR_probe']                   = 50
