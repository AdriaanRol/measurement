...
par_rabi_reps = 20 #if greater than 200, loading the seq. takes long
par_rabi_elt_reps = 1000
par_eom_start = 20
...
par_eom_pulse_amplitude = 0.4
par_eom_overshoot_duration1 = 0
par_eom_overshoot1 = -0
par_eom_overshoot_duration2 = 0
par_eom_overshoot2 = 0

par_eom_aom_amplitude = 0.5
...
par_adwin_probe_threshold = 0 #nr of counts to decide if on resonance BEFORE starting sequence
par_adwin_CR_threshold = 0 #nr of counts to decide if on resonance AFTER sequence
