...
def red_yellow_laser_scan(name):
    ...
    #Scan setup yellow
    m.laser_power_yellow = 0.2e-9
    m.start_voltage_yellow = -7
    m.stop_voltage_yellow = 2
    m.pts_yellow = 600
    m.integration_time_yellow = 200 # ms
...
if __name__=='__main__':
    ...
    red_yellow_laser_scan('red_scan')
