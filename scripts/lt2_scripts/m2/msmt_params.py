...
cfg['protocols']['sil9-default']['AdwinSSRO']['A_CR_amplitude'] = 10e-9
cfg['protocols']['sil9-default']['AdwinSSRO']['A_RO_amplitude'] = 0.
cfg['protocols']['sil9-default']['AdwinSSRO']['A_SP_amplitude'] = 10e-9
cfg['protocols']['sil9-default']['AdwinSSRO']['CR_duration'] = 100
cfg['protocols']['sil9-default']['AdwinSSRO']['CR_preselect'] = 40
cfg['protocols']['sil9-default']['AdwinSSRO']['CR_probe'] = 40
cfg['protocols']['sil9-default']['AdwinSSRO']['Ex_CR_amplitude'] = 10e-9
cfg['protocols']['sil9-default']['AdwinSSRO']['Ex_RO_amplitude'] = 2e-9
