...
- allows sweeping one element (length or voltage)
...
class AdwinPulsesSweep(m2.AdwinControlledMeasurement):
    ...
    def __init__(self, name, adwin):
        ...
        self.adwin=adwin
        self.adwin_process = 'general_pulses_sweep'
...
def yellow_repump_var_length(name):
    m = AdwinPulsesSweep(name, qt.instruments['adwin'])
