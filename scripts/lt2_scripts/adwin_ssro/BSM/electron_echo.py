...
if __name__ == '__main__':
    # echo_delay_sweep('sil9_first_revival')
    # echo_phase_sweep('sil9_first_revival')
    pi_position_sweep('sil9_short_delay_CORPSE_pi')
    # run_CORPSE_echo_phase_sweep('sil9_first_revival')
    
    # BEFORE USING FIX TIMINGS run_N_uncond_rot_calib('sil9_test')
    
    # run_NUrot_vs_timing('sil9_try1')
