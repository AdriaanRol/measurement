...
def postinitdarkesr(name):
    ...
    # ESR pulses
    m.params['RO_MW_pulse_duration'] = 1500
    m.params['RO_MW_pulse_amp'] = 0.02
    
    # MBI
    m.params['MBI_steps'] = 1
    m.params['MBI_duration'] = 5
    m.params['AWG_MBI_MW_pulse_duration'] = 1500
    m.params['AWG_MBI_MW_pulse_amp'] = 0.02
    m.params['AWG_wait_for_adwin_MBI_duration'] = np.array([18000], dtype=int)
