...
def Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weak_value',
   ...
   #WM postselection
    ...
    rot_angle = np.mod(2*0.5*np.arcsin (np.cos(np.pi*exp.sil9['hf_splitting']*1e-9*(tau+minTau))), 2*np.pi)#0.5
...
tau1 = np.linspace (40, 220, 3)
tau3 = np.linspace(1, 10, 3)
tau4 = np.linspace(12, 20, 3)


#optimize()
#ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
#Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepTau_1', tau=tau1, nr_of_pulses=1,nr_of_datapoints = np.size(tau1), reps=20000)
optimize()
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepTau_3', tau=tau3, nr_of_pulses=1,nr_of_datapoints = np.size(tau3), reps=200000)
optimize()
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepTau_4', tau=tau4, nr_of_pulses=1,nr_of_datapoints = np.size(tau4), reps=200000)
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
optimize()
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepTau_3', tau=tau3, nr_of_pulses=1,nr_of_datapoints = np.size(tau3), reps=200000)
