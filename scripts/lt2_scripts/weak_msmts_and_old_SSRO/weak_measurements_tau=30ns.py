...
tau1 = np.linspace (1, 60, 5)
tau2 = np.linspace(120, 180, 5)
tau3 = np.linspace(65, 80, 4)
tau4 = np.linspace(85, 100, 4)
tau5 = np.linspace(105, 115, 3)


optimize()
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepBasisRot_tau=30ns_1', tau=tau1, nr_of_pulses=1,nr_of_datapoints = np.size(tau1), reps=20000)
optimize()
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepBasisRot_30au=1ns_2', tau=tau2, nr_of_pulses=1,nr_of_datapoints = np.size(tau2), reps=20000)
optimize()
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepBasisRot_tau=30ns_3', tau=tau3, nr_of_pulses=1,nr_of_datapoints = np.size(tau3), reps=50000)
optimize()
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepBasisRot_tau=30ns_4', tau=tau4, nr_of_pulses=1,nr_of_datapoints = np.size(tau4), reps=50000)
optimize()
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
Weak_strong_meas(lt1 = False, name = 'SIL9_lt2_weakValue_sweepBasisRot_tau=30ns_5', tau=tau5, nr_of_pulses=1,nr_of_datapoints = np.size(tau5), reps=50000)
ssro.ssro_ADwin_Cal (reps = 10000, Ex_p=30e-9, sweep_power=False, lt1=False, phase_lock=0, name = 'SSRO_calibr')
