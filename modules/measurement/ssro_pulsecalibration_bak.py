...
def Cal_N_pi(pulse_amp,N_pulse,RO_dur=20,Ex_p=6e-9,lt1=True,ESR=None,SSRO=False,ssro_dict={}):
        p_dict = {
                    "Pi":{  "duration": 50., 
                            "amplitude":0.4845
                          },
...
def Cal_all_regular(nr_of_datapoints,RO_dur=20,Ex_p=6e-9,lt1=True,ESR=None,SSRO=False,cal_five=True,cal_pi2=True):
        p_dict = {
                    "Pi":{  "duration": 50.,    # this will be the time of a pi pulse on which we calibrate!
                            "amplitude":0.4845
                          },
        ...
        ms1_readout = 10.                                  # NOTE NOTE NOTE This is the ms=-1 readout value, important!!!!!!!!!!!!!!!
        ...
        if cal_pi2:
            ...
            m.par['Ex_RO_amplitude'] = Ex_p
            m.f_drive=f_drive
            p_dict['Pi']['duration'] = 25.      # determines the lentgh of a pi/2 pulse!!!
