...
import shutil
from analysis import ssro_adwin as ssro_analyse
...
class ssroADwinMeasurement(Measurement):
    ...
    def setup(self,lt1,phase_lock):
        ...
        self.par['wait_after_pulse_duration'] =    3
        self.par['CR_preselect'] =                 15
        ...
        self.par['Ex_CR_amplitude'] =              14e-9
        self.par['A_CR_amplitude'] =               25e-9 # NOTE set to 15e-9 for Ey,A1
        self.par['Ex_SP_amplitude'] =              0e-9
        self.par['A_SP_amplitude'] =               15e-9
        self.par['Ex_RO_amplitude'] =              9e-9 #
    ...
    def measure(self,m,name,sweep_power):
        ...
        if sweep_power:
            ...
            self.ssro_init(name,m, A_SP_init_amplitude = 20e-9, Ex_SP_init_amplitude = 10e-9)
...
def ssro_ADwin_Cal(reps=20000,Ex_p=10e-9,sweep_power=False,lt1=False,phase_lock=1):
    if lt1:
        name='SIL2_LT1'
    else:
        name='SIL9_LT2'
